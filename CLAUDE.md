...
This repository (`bthoreau88/2025May_Team04`) is part of Project ATLAS / OVS OS.
It currently carries QuickPhrase Kotlin sources under `.github/QuickPhrase/` and
a THESE HANDZ Godot scaffold on an open pull request.
